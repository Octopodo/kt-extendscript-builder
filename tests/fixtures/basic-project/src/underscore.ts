(function (global, factory) {
    ...
    var hasDataViewBug =
            supportsDataView &&
            (!/\[native code\]/.test(String(DataView)) || hasObjectTag(new DataView(new ArrayBuffer(8)))),
    ...
    function deepEq(a, b, aStack, bStack) {
        ...
        if (className === '[object RegExp]' || className === '[object String]') {
            ...
            return +a === +b;
        } else if (className === '[object Symbol]') {
            return SymbolProto.valueOf.call(a) === SymbolProto.valueOf.call(b);
        } else if (className === '[object ArrayBuffer]' || className === tagDataView) {
