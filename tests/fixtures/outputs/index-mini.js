...
var KT=/*#__PURE__*/function(){function KT(){_defineProperty(this,"name","KtCore");_defineProperty(this,"version","1.0.0");}KT.salute=function salute(){var obj={name:"KtCore",version:"1.0.0"};alert(JSON.stringify(obj));alert("Hello from ".concat(this.name," "));};KT.init=function init(){return this.name};KT.Module=function Module(name,module){if(this[name]){$.writeln("Module ".concat(name," already exists"));return}this[name]=module;};return KT}();
